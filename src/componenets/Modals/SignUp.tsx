...
const SignUp:React.FC<SignUpProps> = () => {
    ...
    const handleRegister=async (e:React.ChangeEvent<HTMLFormElement>)=>{
        e.preventDefault()
        if(!inputs.email || !inputs.password || !inputs.displayName) return alert("Please fill in all the fields")
        try{
    ...
    return(
        ...
        <div>
            <label htmlFor='email' className='text-sm font-medim block mb-2 text-gray-300'>
                Email
           </label>
           <input
        ...
        <div>
            <label htmlFor='displayName' className='text-sm font-medim block mb-2 text-gray-300'>
                Display Name
           </label>
           <input
            onChange={handleChangeInput}
        ...
        <div>
            <label htmlFor='password' className='text-sm font-medim block mb-2 text-gray-300'>
                Password
           </label>
           <input
            onChange={handleChangeInput}
